...
#define	LCD_TRIS_PORT		DDRD					// Need to specify the corresponding TRIS
...
#define LCD_E SBIT (PORTD, 1)					// Pin for LCD /E signal
//PIN (LCD_RW,		P, 5);					// not used
#define LCD_RS SBIT(PORTD, 0)					// Pin for LCD /E signal
/*
PIN (SEL0,			P1,0);
PIN (SEL1,			P1,1);
PIN (SEL2,			P1,2);
*/					// Add definitions for direction control
#define LCD_TRIS_E SBIT(DDRD, 1)					// Pin for LCD /E signal
//PIN (LCD_TRIS_RW,	TRISC, 4);
#define LCD_TRIS_RS SBIT(DDRD, 0)					// Pin for LCD /E signal
